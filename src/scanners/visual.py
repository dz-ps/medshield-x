...
class VisualPhishingScanner:
    ...
    def __init__(self, logo_path: str = "/app/assets/logo.png"):
    ...
    async def _capture_screenshot(self, url: str, timeout: int = 30000) -> Optional[np.ndarray]:
        """
        ...
        Returns:
            Screenshot as numpy array (BGR format for OpenCV) or None
        """
        try:
    ...
    def _calculate_phishing_score(
        ...
        if logo_found:
            score = 60  # Base score for logo detection
    ...
    async def scan_domain(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Visual analysis complete for {url}: Score={score_result['score']}, Severity={score_result['severity']}")
            return result
